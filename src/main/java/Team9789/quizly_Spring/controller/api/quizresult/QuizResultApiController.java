...
public interface QuizResultApiController {
    ...
    ResponseEntity<ResultDto<String>> saveQuizResultV1(@RequestParam("QuizResult")CreateQuizResultRequest request, @RequestHeader(HttpHeaders.AUTHORIZATION) String authorizationHeader);
